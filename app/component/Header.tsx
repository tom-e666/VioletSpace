...
export default function Header() {
    ...
    if (!authenticated) {
        return (
            <div className="relative top-0 w-full h-16 bg-black border-b border-gray-700 flex flex-row gap-2 items-center px-6 justify-end">
    ...
    return (
        <div className="relative top-0 w-full h-16 bg-black border-b border-gray-700 flex flex-row gap-4 items-center px-6 justify-end">
